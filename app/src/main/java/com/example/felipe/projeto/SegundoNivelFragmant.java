 ...
 */
public class SegundoNivelFragmant extends Fragment{
    ...
    public static SegundoNivelFragmant novaInstancia(
            String texto, int background, int textoColor
    ){
        Bundle params = new Bundle();
        params.putString(EXTRA_TEXTO, texto);
        params.putInt(EXTRA_COR_BG, background);
        params.putInt(EXTRA_COR_TEXTO, textoColor);

        SegundoNivelFragmant snf = new SegundoNivelFragmant();
    ...
    public View onCreateView(
        ...
        View layout = inflater.inflate(
                R.layout.fragment_segundo_nivel,
                container,
                false
        );
